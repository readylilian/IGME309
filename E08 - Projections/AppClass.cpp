...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(false);
		m_pCamera->SetPositionTargetAndUpward(vector3(-10.0f, 0.0f, 0.7f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, -1.0f));
		m_pCamera->SetVerticalPlanes(vector2(-20.0f, 20.0f));
		m_pCamera->SetHorizontalPlanes(vector2(-20.0f, 20.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0.0f, 0.0f, -17.0f));
		//m_pCamera->SetUp(vector3(0.0f, 0.0f, 1.0f));
		//m_pCamera->SetPositionTargetAndUpward(vector3(-10.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, 0.0f), vector3(1.0f, 0.0f, 0.0f));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0.0f, 0.0f, -20.0f));
		m_pCamera->SetNearFar(vector2(10.0f, 1000.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(vector3(0.0f, 0.0f, -20.0f));
		m_pCamera->SetNearFar(vector2(0.1f, 15.0f));
		break;
	case 7:
		m_pCamera->ResetCamera();
